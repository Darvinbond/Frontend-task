...
export default function BlogPreviewPage({}: Props) {
  ...
  return (
    <>
      {doneLoading &&
        (BlogData ? (
          <div className="pt-[120px] lg:pt-[100px] flex flex-col items-center gap-[20px]">
              ...
              <div className="h-[400px] w-full overflow-y-auto">
                <div className="h-max w-full flex gap-[10px] flex-col p-[20px]">
                  {comments.reverse().map((comment, index, array) => (
                    ...
                    >
                      <div>
                        <div className=" w-[30px] lg:w-[50px] aspect-square rounded-full bg-gray-100 justify-center items-center flex">
                          ?
                        </div>
                      </div>
                      <div className="bg-gray-100 rounded-[20px] w-max p-2 lg:p-[15px]">

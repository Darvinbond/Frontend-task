...
export default function Blog() {
  ...
  return (
    <div className="lg:pt-[70px] pt-[120px] flex flex-col gap-[50px]">
      <div className="flex flex-col justify-start w-full gap-[20px]">
        <span className="text-[35px] font-[700]">Blog</span>
      </div>
      {pageBannerData && (
        <div className="w-full h-max lg:h-[500px] bg-[#1d4e4b] overflow-hidden flex flex-col-reverse lg:grid grid-cols-7 border rounded-[30px]">
          <div className="lg:col-span-3  px-[50px] py-[50px] flex flex-col gap-[30px]">
          ...
          <div className="lg:col-span-4 w-full aspect-square lg:aspect-auto overflow-hidden">
            <Image
              alt="Salt Image"
      ...
      <div className="flex flex-col gap-[50px]">
        ...
        {recipeBlogData && recipeBlogData.length > 0 ? (
          <div
            className={`grid ${
              isListView ? "" : " grid-cols-2 lg:grid-cols-4"

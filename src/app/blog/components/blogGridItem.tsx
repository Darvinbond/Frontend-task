...
function BlogGridItem({
  ...
  return (
    <>
      {type_is_grid ? (
        <div className="flex flex-col gap-[5px] rounded-t-[20px] overflow-hidden">
          <div className="w-full block aspect-square lg:aspect-auto lg:h-[250px] overflow-hidden relative">
            <Image
              src={img_url}
              width={100}
              height={100}
          ...
          <span
            className="text-[14px] font-[300] h-[45px] w-full overflow-hidden text-ellipsis"
            // dangerouslySetInnerHTML={stripHTMLTags(content)}
          >
